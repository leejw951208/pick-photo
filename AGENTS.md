...
- Fresh Clarity UI redesign document: `pick-photo/docs/superpowers/specs/2026-05-01-pick-photo-fresh-clarity-ui-redesign-design.md`. It records the selected mobile UI visual direction as bright mint/blue Fresh Clarity while preserving original-photo direct face selection, zoom/pan assistance, bottom selection summary, selected-face-only generation, and unresolved privacy/retention policy boundaries.
...
- Fresh Clarity UI redesign implementation plan: `pick-photo/docs/superpowers/plans/2026-05-01-pick-photo-fresh-clarity-ui-redesign.md`.
...
- Flutter mobile UI visual direction uses the Fresh Clarity theme: bright blue/mint surfaces, clearer status chips and banners, softer cards, and a redesigned photo-flow shell. This is visual-only; it does not change upload, generation, API, AI, database, or retention/deletion behavior.
